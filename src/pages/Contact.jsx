              ...
              <div className='container-block form-wrapper'>
                <div className='head-text-box'>
                  ...
                  <p className='text-blk contactus-subhead'>
                    I'd love to hear from you about potential opportunities,
                ...
                <div className='workik-contact-box'>
                  <div className='phone text-box'>
                    <img
                      ...
                      alt='Phone'
                    />
                    <p className='contact-text'>+1 (813) 743-5217</p>
                  </div>
                  <div className='address text-box'>
                    <img
                      ...
                      alt='Email'
                    />
                    <p className='contact-text'>stnt190@outlook.com</p>
                  </div>
                  <div className='mail text-box'>
                    <img
                      ...
                      alt='Location'
                    />
                    <p className='contact-text'>Tampa, FL</p>
                  </div>
                </div>
